...
type
  TFormMain = class(TForm)
    ...
    procedure gridSudokuKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
  private
  ...
  public
    ...
    Number: 1 .. 9;
    Jeu: Boolean;
    InitialDigit, UserDigit: array [0 .. 8, 0 .. 8] of char;
  end;
...
procedure TFormMain.gridSudokuKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
